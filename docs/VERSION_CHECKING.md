...
```
🔍 Проверка обновлений (режим: docker, текущая версия: 1.0.22)...
📦 Доступна новая версия: 1.0.22 (текущая: 1.0.22)
...
Текущая: v1.0.22
Режим: docker
Доступна: v1.0.22 (опубликована: 10.06.2026, 14:30)
```
