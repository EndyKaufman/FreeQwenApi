...
```
🔍 Проверка обновлений (режим: docker, текущая версия: 1.0.21)...
📦 Доступна новая версия: 1.0.21 (текущая: 1.0.21)
...
Текущая: v1.0.21
Режим: docker
Доступна: v1.0.21 (опубликована: 10.06.2026, 14:30)
```
