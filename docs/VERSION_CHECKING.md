...
```
🔍 Проверка обновлений (режим: docker, текущая версия: 1.0.19)...
📦 Доступна новая версия: 1.0.19 (текущая: 1.0.19)
...
Текущая: v1.0.19
Режим: docker
Доступна: v1.0.19 (опубликована: 10.06.2026, 14:30)
```
